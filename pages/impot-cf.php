<?php
/**
 * IMPOT - CF (Contribution Forfaitaire)
 */
session_start();
...
<body class="bg-slate-100 min-h-screen">
    ...
    <div class="bg-white border-b">
        <div class="max-w-7xl mx-auto px-4">
            <nav class="flex space-x-1 overflow-x-auto">
                ...
                <a href="impot-cf.php?client=<?=$clientId?>&mois=<?=$mois?>&annee=<?=$annee?>" class="px-4 py-3 text-sm font-medium text-white bg-blue-600 rounded-t-lg whitespace-nowrap">CF</a>
    ...
    <main class="max-w-7xl mx-auto px-4 py-6">
        <h1 class="text-2xl font-bold text-slate-800 mb-6">CF - Contribution Forfaitaire</h1>
                ...
                <table class="w-full max-w-2xl mx-auto">
                    <tbody>
                        ...
                        <tr class="border-b border-slate-100">
                            ...
                            <td class="py-4 text-right">
                                <input type="text" class="w-48 px-3 py-2 border border-slate-300 rounded text-right font-semibold bg-slate-50" value="<?= $tauxCF ?> %" readonly>
                            </td>
                        </tr>
                        <tr class="bg-blue-50">
                            <td class="py-4 px-2 text-slate-700 font-semibold">Montant à payer</td>
                            <td class="py-4 px-2 text-right">
                                <input type="text" class="w-48 px-3 py-2 border-2 border-blue-400 bg-blue-50 rounded text-right font-bold text-blue-700" value="<?= formatMontant($cf) ?> F CFA" readonly>
                            </td>
                        </tr>
                    </tbody>
                </table>
